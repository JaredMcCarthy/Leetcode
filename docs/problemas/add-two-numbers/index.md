...
<div class="problem-header">
  ...
  <div>
    <div><strong>Add Two Numbers</strong> <span class="badge-medium">Medium</span></div>
    <div><strong>Tags:</strong> Linked List, Math, Recursion</div>
  </div>
</div>
...
<div class="navigation">
  <a class="prev" href="../two-sum/">Anterior</a>
  <a class="next" href="../longest-substring-without-repeating-characters/">Siguiente</a>
</div>
